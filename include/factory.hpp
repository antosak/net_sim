...
public:
    ...
    NodeCollection<Node>::iterator find_by_id(ElementID id_) {
        return std::find_if(this->container.begin(),
    ...
    NodeCollection<Node>::const_iterator find_by_id(ElementID id_) const {
        return std::find_if(this->container.cbegin(),
...
public:
    ...
    find_storehouse_by_id(ElementID id) const { return storehouses.find_by_id(id); }
